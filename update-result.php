...
{
$sql1="UPDATE results SET Computer=$cm,English=$em,Hindi=$hm,Science=$sm,Social=$mm,Updation_Date='$date' WHERE Roll_Id='$sid' AND Class=$class AND Section='$sec'";
if(mysqli_query($conn,$sql1))
{
echo "<p id='a' style='color:MediumVioletRed'>Marks Updated Successfully!</p>";
}
else
{
