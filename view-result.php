...
$sql="SELECT * FROM results WHERE Roll_Id='$sid'";
$sql1="SELECT Student_Name FROM student WHERE Roll_Id='$sid'";
...
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Student Name</th><td style='border:1px solid black'>".$row1['Student_Name']."</td></tr>";
...
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Computer</th><td style='border:1px solid black'>".$row['Computer']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>English</th><td style='border:1px solid black'>".$row['English']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Hindi</th><td style='border:1px solid black'>".$row['Hindi']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Science</th><td style='border:1px solid black'>".$row['Science']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Social</th><td style='border:1px solid black'>".$row['Social']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Total</th><td style='border:1px solid black'>".$row['Total']."</td></tr>";
echo "<tr style='border:1px solid black'><th style='border:1px solid black'>Percentage</th><td style='border:1px solid black'>".$row['Percentage']."</td></tr>";
echo "</table>";
echo "<script>document.getElementById('ht').style.height='30em';</script>";
}
}
}
?>
